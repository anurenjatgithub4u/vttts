...
import PhysicalVariants from '../components/products/physical/physical-variants'
import UpdateForm from '../components/products/physical/UpdateForm'
		...
		<Fragment>
			<Routes>
				<Route element={<App />}>
					...
					<Route
						path={`${process.env.PUBLIC_URL}/products/physical/physical-variants`}
						element={<PhysicalVariants />}
					/>
					<Route
					...
					/>
					<Route
						path={`${process.env.PUBLIC_URL}/products/physical/updateForm`}
						element={<UpdateForm />}
					/>
