      ...
      <Animatable.View animation="slideInRight" style={{ flex: 1, backgroundColor: '#ededfc', paddingHorizontal: 20, }}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={{ paddingTop: 20 }}>
            <Text style={{ fontFamily: 'OpenSans-Regular', fontSize: 14, color: '#252f40', lineHeight: 22 }}>Enter the 4 digit code that you received on your mobile </Text>
          </View>
...
export default CitizensOtpVerifyScreen;
