...
import { ScrollView, View, StatusBar, Dimensions, Pressable, BackHandler } from 'react-native';
...
const AddUserPersonalInfo = ComponentLoadable(lazy(() => import('../ChaildComponent/EditUserComponent/AddUserPersonalInfo')));
const AddUserSettings = ComponentLoadable(lazy(() => import('../ChaildComponent/EditUserComponent/AddUserSettings')));
const AddUserPermission = ComponentLoadable(lazy(() => import('../ChaildComponent/EditUserComponent/AddUserPermission')));
    ...
    <Fragment>
      ...
      <View style={{
        ...
        <Box style={[{ display: 'flex', alignItems: 'center', flexDirection: 'row', justifyContent: 'center', marginBottom: 20, }]}>
          <Center>
            <Text style={{ fontSize: 16, fontFamily: 'OpenSans-Bold', color: '#000000' }}>Edit User</Text>
          </Center>
