...
import { View, StatusBar, Dimensions, Pressable, BackHandler } from 'react-native';
import { Box, Text, Center, } from 'native-base';
import Ionicons from 'react-native-vector-icons/Ionicons';
import ComponentLoadable from '../Suspense_Component/ComponentLoadable';


const EditAlarm = ComponentLoadable(lazy(() => import('../ChaildComponent/EditAlarmComponent/EditAlarm')));

const EditAlarmScreen = ({ navigation }) => {
    ...
    <Fragment>
      ...
      <View style={{
        ...
        <Box style={[{ display: 'flex', alignItems: 'center', flexDirection: 'row', justifyContent: 'center', marginBottom: 20, }]}>
          <Center>
            <Text style={{ fontSize: 16, fontFamily: 'OpenSans-Bold', color: '#000000' }}>Edit Alarm</Text>
          </Center>
      ...
      <EditAlarm navigation={navigation} />
    </Fragment>
  )
}
