...
const DeviceDetails = ComponentLoadable(lazy(() => import('../ChaildComponent/EditEntityComponent/EditDeviceDetails')));
const SimDetails = ComponentLoadable(lazy(() => import('../ChaildComponent/EditEntityComponent/EditSimDetails')));
const VehicleDetails = ComponentLoadable(lazy(() => import('../ChaildComponent/EditEntityComponent/EditVehicleDetails')));
const PermitHolder = ComponentLoadable(lazy(() => import('../ChaildComponent/EditEntityComponent/EditPermitHolder')));

const EditEntityScreen = ({ navigation }) => {
    ...
    <Fragment>
      ...
      <View style={{
        ...
        <Box style={[{ display: 'flex', alignItems: 'center', flexDirection: 'row', justifyContent: 'center', marginBottom: 20, }]}>
          <Center>
            <Text style={{ fontSize: 16, fontFamily: 'OpenSans-Bold', color: '#000000' }}>Edit Entity</Text>
          </Center>
