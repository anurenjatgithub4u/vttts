...
import CreateRoute from '../ChaildComponent/CreateRouteComponent/CreateRoute'
      ...
      <View style={{ flex: 1, backgroundColor: '#f5f6fa', }}>
        <View style={{
          ...
          <Box style={[{ display: 'flex', alignItems: 'center', flexDirection: 'row', justifyContent: 'center', marginBottom: 20, }]}>
            <Center>
              <Text style={{ fontSize: 16, fontFamily: 'OpenSans-Bold', color: '#000000' }}>Create Route</Text>
            </Center>
