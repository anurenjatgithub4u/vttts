...
import GeneralInfo from '../ChaildComponent/ScheduleReportComponent/GeneralInfo';
import Timing from '../ChaildComponent/ScheduleReportComponent/Timing';

const ScheduleReportScreen = ({ navigation }) => {
      ...
      <View style={{ backgroundColor: '#f5f6fa', flex: 1 }}>
        ...
        <View style={{
          ...
          <Box style={[{ display: 'flex', alignItems: 'center', flexDirection: 'row', justifyContent: 'center', marginBottom: 20, }]}>
            <Center>
              <Text style={{ fontSize: 16, fontFamily: 'OpenSans-Bold', color: '#000000' }}>Schedule Report</Text>
            </Center>
