...
class TrackingAnimationActivity extends Component {
  ...
  callApi() {
    MapplsGL.RestApi.direction({
      origin: `${this?.props?.routeCoord?.startLon},${this?.props?.routeCoord?.startLat}`,
      destination: `${this?.props?.routeCoord?.endLon},${this?.props?.routeCoord?.endLat}`,
      resource: 'route_eta',
      profile: 'driving',
      overview: 'simplified',
    }).then(response => {
